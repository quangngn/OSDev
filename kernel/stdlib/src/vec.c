...
bool imat4x4_matmul(imat4x4_t *m1, imat4x4_t *m2, imat4x4_t *res){
    ...
    res->c2.x = m1->c1.x * m2->c2.x + m1->c2.x * m2->c2.y + m1->c3.x * m2->c2.z + m1->c4.x * m2->c2.w;
    res->c2.y = m1->c1.y * m2->c2.x + m1->c2.y * m2->c2.y + m1->c3.y * m2->c2.z + m1->c4.y * m2->c2.w;
    res->c2.z = m1->c1.z * m2->c2.x + m1->c2.z * m2->c2.y + m1->c3.z * m2->c2.z + m1->c4.z * m2->c2.w;
    res->c2.w = m1->c1.w * m2->c2.x + m1->c2.w * m2->c2.y + m1->c3.w * m2->c2.z + m1->c4.w * m2->c2.w;

    res->c3.x = m1->c1.x * m2->c3.x + m1->c2.x * m2->c3.y + m1->c3.x * m2->c3.z + m1->c4.x * m2->c3.w;
    res->c3.y = m1->c1.y * m2->c3.x + m1->c2.y * m2->c3.y + m1->c3.y * m2->c3.z + m1->c4.y * m2->c3.w;
    res->c3.z = m1->c1.z * m2->c3.x + m1->c2.z * m2->c3.y + m1->c3.z * m2->c3.z + m1->c4.z * m2->c3.w;
    res->c3.w = m1->c1.w * m2->c3.x + m1->c2.w * m2->c3.y + m1->c3.w * m2->c3.z + m1->c4.w * m2->c3.w;

    res->c4.x = m1->c1.x * m2->c4.x + m1->c2.x * m2->c4.y + m1->c3.x * m2->c4.z + m1->c4.x * m2->c4.w;
    res->c4.y = m1->c1.y * m2->c4.x + m1->c2.y * m2->c4.y + m1->c3.y * m2->c4.z + m1->c4.y * m2->c4.w;
    res->c4.z = m1->c1.z * m2->c4.x + m1->c2.z * m2->c4.y + m1->c3.z * m2->c4.z + m1->c4.z * m2->c3.w;
    res->c4.w = m1->c1.w * m2->c4.x + m1->c2.w * m2->c4.y + m1->c3.w * m2->c4.z + m1->c4.w * m2->c4.w;   
...
bool imat4x4_equal(imat4x4_t *m1, imat4x4_t *m2){
    ...
    return ivec4_equal(&(m1->c1), &(m2->c1)) && ivec4_equal(&(m1->c2), &(m2->c2)) && ivec4_equal(&(m1->c3), &(m2->c3)) && ivec4_equal(&(m1->c4), &(m2->c4));
}
...
bool fmat4x4_equal(fmat4x4_t *m1, fmat4x4_t *m2){
    ...
    return fvec4_equal(&(m1->c1), &(m2->c1)) && fvec4_equal(&(m1->c2), &(m2->c2)) && fvec4_equal(&(m1->c3), &(m2->c3)) && fvec4_equal(&(m1->c4), &(m2->c4));
}